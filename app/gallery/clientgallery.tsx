            ...
            {activeImg && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
                    ...
                    <div className="relative max-w-6xl w-full" onClick={(e) => e.stopPropagation()}>
                        ...
                        />
                        <button className="absolute top-2 right-4 text-white text-3xl font-bold"
                            onClick={() => setActiveImg(null)}
                            aria-label="Close"
                        >&times;</button>
                        {/* <button className="absolute bottom-4 text-shadow-xl right-4 text-white text-3xl font-bold"
