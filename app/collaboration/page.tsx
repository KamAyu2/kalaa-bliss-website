...
export default function Collabration() {
    ...
    const serviceSchema = {
        ...
        "@type": "Service",
        "serviceType": "Animation and Illustration Services",
        "provider": {
            "@type": "Person",
            "name": "Khushbu Gupta",
        ...
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Brand Collaboration Services",
            "itemListElement": [
                {
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Animated Reels",
                        "description": "Custom-crafted animated content designed to capture attention in crowded feeds. Perfect for product launches, brand storytelling, and campaign highlights.",
                        "serviceOutput": "15-60 second animations optimized for Instagram/TikTok"
                    }
                },
                {
                    "@type": "Offer",
                    "itemOffered": {
                        ...
                        "description": "Dynamic story sequences that engage followers with visual narratives. Ideal for ongoing brand presence and audience connection.",
                        "serviceOutput": "5-10 story frames with interactive elements"
                    }
                },
                {
                    "@type": "Offer",
                    "itemOffered": {
                        ...
                        "description": "Bespoke illustrations that capture your brand's unique identity. From character design to full campaign visuals.",
                        "serviceOutput": "Custom artwork with style guide and high-res files"
                    }
                },
                {
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Animated Posts",
                        "description": "Engaging animated posts that stand out in feeds. Great for announcements, promotions, and enhancing brand visibility.",
                        "serviceOutput": "Custom animated social media posts"
                    }
                }
            ]
        },
        ...
        "url": "https://kalaabliss.in/collaboration"
    };

    const ratingSchema = {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Kalaa Bliss Animation Services",
        "aggregateRating": {
        ...
        <>
            ...
            <div className="anime-wrapper py-12 relative min-h-screen overflow-x-hidden max-w-screen">
                <AnimateOnScroll animation="fade-in-down">
                    <h1 className={`${italianno.className} text-6xl md:text-7xl mb-4 flex justify-center`}>Collaborate</h1>
                </AnimateOnScroll>
                <section className='w-full md:w-11/12 mx-auto mb-12 flex flex-col md:flex-row gap-8 md:gap-4 items-center justify-center'>
                    <div className="mx-8 md:mx-12 my-8 flex flex-col gap-4 justify-center">
                        ...
                        <AnimateOnScroll animation="fade-in-down" delay={400}>
                        ...
                        <AnimateOnScroll animation="fade-in-down" delay={600}>

                            <div className='flex gap-2'>
                                <Link
                                    className="bg-[#ff58e0] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#e700ade7] transition duration-300 cursor-pointer "
                                    href="/connect"
                                >
                                    Get in Touch
                                </Link>
                                <Link
                                    className="border-2 font-semibold border-black text-black px-6 py-3 rounded-full hover:bg-gray-400 transition duration-300 cursor-pointer "
                                    href="/gallery"
                                >
                                    Explore My Work
                                </Link>
                    ...
                    <div className="collab-text-container mx-8 md:mx-16 my-8 flex flex-col gap-4 text-start">
                        ...
                        <div className='mt-8 flex flex-col gap-12 '>
                            ...
                            <AnimateOnScroll animation="fade-in-down">
                                ...
                                <div className='flex flex-col md:flex-row-reverse gap-8 md:gap-16 mt-8 text-center items-center w-full md:w-11/12  mx-auto'>
                                    <Image
                                        src="/work/b.png"
                                        height={283}
                                        width={364}
